# The clould folder handles cloud related input-output if needed
...
class MongoIO:
    ...
    def __init__(self):
        if MongoIO.mongo_ins is None:
            mongo_db_url = "mongodb+srv://surajojha2626:12345@cluster0.mubxy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
